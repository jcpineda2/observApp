...
<div class="rounded-2xl bg-white p-5 shadow-sm ring-1 ring-gray-200">
    <div class="flex items-start justify-between gap-3">
        <div>
            <h3 class="text-sm font-semibold text-gray-900">Top Aerolíneas por asientos</h3>
            <p class="mt-1 text-xs text-gray-500">Ranking por asientos ofertados (Top {{ $limit }})</p>
        </div>
