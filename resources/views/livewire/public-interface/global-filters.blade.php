    ...
    <div class="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        ...
        <div class="grid w-full gap-3 sm:grid-cols-3 lg:w-auto">
            <div class="sm:min-w-52">
                <label class="block text-xs font-medium text-gray-600 dark:text-slate-300">Año</label>
            ...
            <div class="sm:min-w-52">
                <label class="block text-xs font-medium text-gray-600 dark:text-slate-300">Mes</label>
            ...
            <div class="sm:min-w-40">
                <button type="button" wire:click="resetFilters" class="mt-5 w-full ui-btn-primary">
                    Limpiar
                </button>
            </div>
        </div>
