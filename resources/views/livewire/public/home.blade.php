<section class="py-10 lg:py-14">
    <div class="rounded-3xl border border-gray-200 bg-white px-6 py-8 shadow-sm dark:border-slate-800 dark:bg-[#08122e] sm:px-8 lg:px-10 lg:py-10">
        <div class="grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
            ...
            <div class="rounded-3xl border border-gray-200 bg-gray-50 p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/80">
                ...
                <div class="mt-5 grid gap-3 sm:grid-cols-2">
                    <a
                        wire:navigate
                        href="{{ route('public.domestic') }}"
                        class="rounded-2xl border border-gray-200 bg-white p-4 transition hover:bg-gray-50 dark:border-slate-700 dark:bg-slate-900 dark:hover:bg-slate-800"
                    >
